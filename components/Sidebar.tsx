...
import { 
  ...
  LogOutIcon, SettingsIcon, AppleIcon, ImageIcon, PenSquareIcon, MessageSquareIcon, ZenArcadeIcon
} from './IconComponents';
...
const Sidebar: React.FC<SidebarProps> = ({ currentPage, onNavigate, isExpanded, onToggle }) => {
  ...
  return (
    <aside className={`flex flex-col flex-shrink-0 bg-white/50 dark:bg-slate-800/50 backdrop-blur-lg transition-all duration-300 ease-in-out ${isExpanded ? 'w-64' : 'w-20'}`}>
      {/* Logo */}
